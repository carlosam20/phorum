<%@ taglib uri="http://www.springframework.org/tags/form" prefix="springform" %>
	<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
		...
		<head>
			<meta charset="UTF-8">
			<title>formularioRegistrarFollow</title>
		...
		<body>
			<div class="row text-center align-items-start">
				<div class="col-lg-12 col-md-12 col-sm-12">
					<h1>Registro de follow</h1>
				</div>
			</div>

			<div class="registrarFollow my-3">
				<div class="row my-3 mx-2 text-center d-flex justify-content-center align-items-center">
					<div class="col-lg-8 col-md-8 col-sm-8 my-3 mx-1">
						...
						<springform:form modelAttribute="nuevoFollow" action="guardarNuevoFollow"
